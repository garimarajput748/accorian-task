...
<!-- Mirrored from accorian.com/ by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 14 Dec 2022 11:48:53 GMT -->
                                        ...
                                        <ul class="main-menu list-style">
                                            ...
                                            <li class="has-children">
                                                ...
                                                <ul class="sub-menu list-style">
                                                    ...
                                                    <li><a href="mobile-web-app-development.html"><i class="fa fa-angle-right"></i> SECURITY COMPLIANCE & ASSESSMENT SERVICES</a></li>
                                                    <li><a href="digital-marketing.html"><i class="fa fa-angle-right"></i>
                                                            RED TEAM ASSESSMENTS</a>
                                                    </li>
                                                    <li><a href="maintenance-services.html"><i class="fa fa-angle-right"></i> TECHNOLOGY STAFFING</a></li>
                                                    <li><a href="managed-ict-services.html"><i class="fa fa-angle-right"></i> CONSULTING & ASSESSMENT SERVICES</a>
                                                    </li>
                                                </ul>
                                            </li>
                                            <li>
